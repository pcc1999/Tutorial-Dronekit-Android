...
public class DroidPlannerService extends Service {
    ...
    private void updateForegroundNotification() {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(String.valueOf(FOREGROUND_ID),
                    FOREGROUND_ID + "_name",
        ...
        final NotificationCompat.Builder notifBuilder = new NotificationCompat.Builder(context, String.valueOf(FOREGROUND_ID))
